...
(() => {
    ...
    class Ball{
        constructor(canvas){
            ...
            this.y = 30;
            this.r = 10;
            this.vx = rand(5,10) * (Math.random() < 0.5 ? 1 : -1);
            this.vy = rand(5,10);
            this.isMissed = false;
        }
    ...
    class Paddle{
        ...
        update(ball){
            ...
            if (
                ballBottom > paddleTop && ballTop < paddleBottom &&  ballCenter > paddleLeft && ballCenter < paddleRight
            ){
                ball.bounce();
    ...
    drawGameOver(){
        ...
        this.ctx.fillText('YOUR LOSE ', 100,250);
    }
